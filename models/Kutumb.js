...
const Kutumb = sequelize.define(
  'kutumb',
  {
    ...
    caste_name: { type: DataTypes.STRING(150), allowNull: false },
    sur_name: { type: DataTypes.STRING(150), allowNull: false },
    sub_sur_name: { type: DataTypes.STRING(150), allowNull: false },
    gotra: { type: DataTypes.STRING(150), allowNull: false },
    community_id: { type: DataTypes.INTEGER, allowNull: false },
    status: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1 },
    user_id: { type: DataTypes.INTEGER, allowNull: false },
    state_name: { type: DataTypes.STRING(150), allowNull: false },
